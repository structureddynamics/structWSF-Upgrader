...
# This script upgrades structWSF from version 1.0a92 to 1.0a93

STRUCTWSFVERSION="1.0a93"
STRUCTWSFPREVIOUSVERSION="1.0a92"
...
# Make sure there is no trailing slashes
DATA_INI=$(echo "${DATA_INI}" | sed -e "s/\/*$//")

VIRTUOSOMAINVERSION="6"

cecho "What is the main version of the Virtuoso server used by this structWSF instance (4, 5 or 6) (default: $VIRTUOSOMAINVERSION):" $magenta

read NEWVIRTUOSOMAINVERSION

[ -n "$NEWVIRTUOSOMAINVERSION" ] && VIRTUOSOMAINVERSION=$NEWVIRTUOSOMAINVERSION

sudo sed -i 's>\[triplestore\]>\[triplestore\] \n\n; Main version of the Virtuoso server used by this structWSF instance (4, 5 or 6) \nvirtuoso_main_version = "'$VIRTUOSOMAINVERSION'"\n>' $DATA_INI"/data.ini"

ENABLELRL="FALSE"

cecho "Is the Virtuoso instance used on this server 6.1.5 and greater, or has it been patched for the Long Read Len issue using the spasql-php.diff patch? (y/n):" $magenta
...
sudo sed -i 's>\[triplestore\]>\[triplestore\] \n\n; Enable the Long Read Len feature of Virtuoso.\n; Important Note: to enable this feature, you have to have Virtuoso 6.1.5 and greater\n;                 installer, or to have applied the sposql-php.diff path\n; Note: if this feature is not enabled, literals longer than 4072 characters will be truncated\n;       when returned by the CrudRead web service endpoint.\nenable_lrl = "'$ENABLELRL'"\n>' $DATA_INI"/data.ini"
