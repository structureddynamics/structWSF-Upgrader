...
STRUCTWSFPREVIOUSVERSION="1.0a93"
...
cecho "\n\nDelete the deprecated Browser web service endpoint...\n"

sudo rm -rf $STRUCTWSFFOLDER"/browse/"

cecho "\n\nDelete the deprecated CompoundWebService class...\n"

sudo rm -f $STRUCTWSFFOLDER"/framework/CompoundWebService.php"

cecho "\n\nDelete the deprecated RdfClass class...\n"

sudo rm -f $STRUCTWSFFOLDER"/framework/RdfClass.php"
